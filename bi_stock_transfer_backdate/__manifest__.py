...

{
    ...
    'version'       : '14.0.0.1',
    'category'      : 'Warehouse',
    'summary'       : 'stock transfer backdate stock transfers backdate inventory transfer backdating stock backdate stock accounting backdate inventory backdate stock backdate delivery backdate stock transfer force date on stock transfer inventory force date picking backdate',
    ...
    'installable'   : True,
    'auto_install'  : False,
    'qweb': ['static/src/xml/inventory_line.xml'],
    "live_test_url":'https://youtu.be/KDXuRBH9rbY',
